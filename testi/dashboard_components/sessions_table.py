...
def render_sessions_table(db_path='session.db', refresh_interval=2, show_newest=20):
    ...
    column_mapping = {
        ...
        'score_updated_ts': 'Score Updated TS',
        'last_decision_ts': 'Last Decision TS',
        'decision_tier': 'Tier',
    ...
    display_columns = [
        ...
        'Action', 'Label', 'Score', 'Anomaly Score', 'Endpoint Score', 'TI Score',
        'IAM Score', 'Combined Score', 'Risk Score', 'Score Updated TS', 'Last Decision TS',
        'Tier', 'Reason'
    ]
